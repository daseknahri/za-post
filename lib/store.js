...
// Local calendar-day key (YYYY-MM-DD) for per-account daily-cap bookkeeping. Local time so the
// "day" matches the operator's clock, not UTC.
...
module.exports = {
  ...
  saveBase64Image, loadRotation, saveRotation, sanitizeProfile, todayKey,
